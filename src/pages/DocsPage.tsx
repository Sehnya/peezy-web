...
const DocsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-yellow-200">
            {/* Mobile Navigation */}
            <div className="lg:hidden bg-yellow-100 border-b border-yellow-300 sticky top-16 z-20">
                <div className="px-4 py-3">
                    <select
                        value={activeSection}
                        onChange={(e) => scrollToSection(e.target.value)}
                        className="w-full px-3 py-2 bg-yellow-50 border border-yellow-300 rounded-lg text-[#177455] text-sm"
                    >
            ...
            <div className="lg:flex">
                {/* Desktop Sidebar */}
                <div className="hidden lg:block w-80 bg-yellow-100 border-r border-yellow-300 fixed h-full overflow-y-auto">
                    <div className="p-6">
